...
const quickActions: {
    ...
    { id: 'docs', label: 'Docs 작성', icon: BookText, href: '/docs' },
    {
      id: 'issue',
      label: '새 이슈',
      icon: FolderKanban,
      ...
      return (
        <GlassCard>
          <div className="flex items-center justify-between border-b border-border px-5 py-4">
            ...
            <Link href="/issues" className="text-xs font-medium text-primary transition hover:underline">
              Kanban 열기 →
            </Link>
          </div>
      ...
      return (
        <GlassCard>
          <div className="flex items-center justify-between border-b border-border px-5 py-4">
            ...
            <Link href="/issues" className="text-xs text-muted transition hover:text-foreground">
              전체 보기 →
            </Link>
          </div>
      ...
      return (
        <GlassCard>
          <div className="flex items-center justify-between border-b border-border px-5 py-4">
            ...
            <Link href="/chat" className="text-xs text-muted transition hover:text-foreground">
              채팅으로 이동 →
            </Link>
          </div>
          <div className="space-y-3 p-5">
